...
check_scene_output "scenes/bunny.ao.flatland.xml" "scenes/bunny.ao.svg" "scenes/bunny.ao_ref.svg"
check_scene_output "scenes/bunny.flatland.xml" "scenes/bunny.svg" "scenes/bunny_ref.svg"
check_scene_output "scenes/disk.ao.flatland.xml" "scenes/disk.ao.svg" "scenes/disk.ao_ref.svg"
