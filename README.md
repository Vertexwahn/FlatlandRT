...
* [Abseil](/third_party/abseil) (https://abseil.io/) (see `third_party` folder)
* [Boost](/third_party/boost) (https://www.boost.org/) ([License](/third_party/boost))
* [Boost](https://www.boost.org/) (third party dependency) ([License](/third_party/LICENSES/boost/LICENSE))
* [Catch2](third_party/Catch2) (https://github.com/catchorg/Catch2) ([License](/third_party/Catch2/LICENSE.txt))
* [Eigen](third_party/eigen-3.4.0) ([License](/third_party/eigen-3.4.0/COPYING.APACHE))
* [Google Test](third_party/googletest) (https://github.com/google/googletest) ([License](/third_party/googletest/LICENSE)
* [Imath](/third_party/Imath)
* [OpenEXR](/third_party/openexr) (https://github.com/AcademySoftwareFoundation/openexr) ([License](/third_party/openexr/LICENSE.md))
* [gflags](/third_party/gflags) (https://github.com/gflags/gflags/) (see `third_party` folder)
* [glog](/third_party/glog) (https://github.com/google/glog) (see `third_party` folder)
* [hypothesis](/third_party/hypothesis) (https://github.com/wjakob/hypothesis) (see `third_party` folder)
...
* [rules_pkg](/third_party/rules_pkg)
* [yaml-cpp](/third_party/yaml-cpp) (https://github.com/jbeder/yaml-cpp) (third party dependency) ([License](third_party/yaml-cpp/LICENSES/yaml-cpp/LICENSE))
* [zlib](/third_party/zlib) (https://zlib.net/) ([License](devertexwahn/flatland/LICENSES/third_party/zlib-1.2.11/README))
* [{fmt}](/third_party/fmt) (https://github.com/fmtlib/fmt) ([License](/third_party/fmt/LICENSE))
