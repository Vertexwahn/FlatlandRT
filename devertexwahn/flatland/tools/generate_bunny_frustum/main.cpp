...
int main() {
    ...
    far_polygon->set_material(material);
    near_polygon->set_material(material);
    ...
    transformedFrustum->set_material(material);
    ...
    transformedFrustumAfterHomo->set_material(material);
