...
public:
    ...
    void set_emitter(ReferenceCounted<EmitterType<ScalarType, Dimension>> emitter) {
        emitter_ = emitter;
    }
    ReferenceCounted<EmitterType<ScalarType, Dimension>> emitter() const {
        return emitter_;
    }
...
protected:
    ...
    ReferenceCounted<EmitterType<ScalarType, Dimension>> emitter_{nullptr};
};
...
public:
    ...
    [[nodiscard]]
    std::string convert_color3f_to_svg_color3b(const ColorRGB3f &color) const {
        std::stringstream ss;
